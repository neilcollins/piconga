...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Conga', fields ['name']
        db.create_unique(u'conga_conga', ['name'])


    def backwards(self, orm):
        # Removing unique constraint on 'Conga', fields ['name']
        db.delete_unique(u'conga_conga', ['name'])
