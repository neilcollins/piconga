...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CongaUser.host'
        db.alter_column(u'conga_congauser', 'host', self.gf('django.db.models.fields.CharField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'CongaUser.host'
        db.alter_column(u'conga_congauser', 'host', self.gf('django.db.models.fields.CharField')(max_length=20))
